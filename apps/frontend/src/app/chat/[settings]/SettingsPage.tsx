...
export default function SettingsPage() {
  ...
  return (
    ...
    <Dialog>
      <DialogTrigger className={'flex gap-2 items-center hover:bg-gray-200 p-2 rounded-md  '}>
      ...
      <DialogContent className="rounded-xl min-h-[80vh] min-w-[80vw] max-w-[80vw] flex flex-col p-0">
        ...
        <div className="grid grid-cols-[200px_1fr] flex-1 overflow-hidden">
          <nav className="flex flex-col p-2  rounded-md">
            <Button variant="ghost" className={'flex justify-start'} name='profile' onClick={() => setSelectedNavItem('profile')}>
...
function LogoutButton() {
  ...
  return (
    <Button variant="destructive" onClick={handleLogout} disabled={isPending} className="flex justify-start">
