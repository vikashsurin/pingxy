...
import { useFetchParticipants } from "@/src/hooks/api/useConversations";
    ...
    return (
      <div className="m-2 p-4 rounded-lg border border-gray-300 bg-gray-100">
        <h2 className="font-bold text-lg flex items-center gap-2">
          ...
          <span className="bg-blue-100 h-5 w-5 flex items-center justify-center text-xs text-blue-700 py-1 px-1.5 rounded aspect-square">
            {data?.length}
          </span>
        </h2>
        <div>
