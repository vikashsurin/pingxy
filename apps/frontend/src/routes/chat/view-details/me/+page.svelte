...
{#if chatStore.currentUser}
  <div class="max-w-2xl mx-auto p-6">
    ...
    >
      ...
      <div class="space-y-4">
        <div class="space-y-1">
          <span class="text-xs font-medium text-gray-700 ml-1">Gender</span>
          <div class="flex gap-2">
            ...
            >
              <input
                ...
                checked={chatStore.currentUser?.data.gender === "female"}
              />
            ...
            >
              <input
                ...
                value="male"
                class="accent-blue-500"
                checked={chatStore.currentUser?.data.gender === "male"}
              />
        ...
        <div class="space-y-1">
          <span class="text-xs font-medium text-gray-700 ml-1">Country</span>
          <select
            name="country"
        ...
        <div class="space-y-1">
          <span class="text-xs font-medium text-gray-700 ml-1">Bio</span>
          <textarea
            name="bio"
            rows="4"
