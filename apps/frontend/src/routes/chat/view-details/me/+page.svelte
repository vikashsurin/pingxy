        ...
        >
            ...
            <div class="space-y-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        >
                            <input
                                ...
                                checked={chatStore.currentUser?.gender ===
                                    "female"}
                            />
                ...
                <div class="space-y-1">
                    ...
                    <select
                        name="country"
                        value={chatStore.currentUser?.country}
                ...
                <div class="space-y-1">
                    ...
                    <textarea
                        name="bio"
                        rows="4"
                        value={chatStore.currentUser?.bio || ""}
            ...
            <div class="flex items-center gap-4 mt-2">
                <button
                    disabled={loading}
                    class="bg-blue-600 text-white py-2.5 px-6 rounded-lg font-medium hover:bg-blue-700 active:bg-blue-800 transition-colors disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2 min-w-[120px] justify-center"
                >
                    {#if loading}
