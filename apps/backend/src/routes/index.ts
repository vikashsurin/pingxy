...
import { conversationInviteRouter } from "@modules/conversation-invites/conversation-invite.routes";
...
export function registerRoutes(app: any) {
  ...
  app.route("/api/conversation-invites", conversationInviteRouter);
